...
export const skills = [
  { name: 'HTML',                 level: 'Expert',    dots: 5 },
  { name: 'CSS',                  level: 'Expert',    dots: 5 },
  { name: 'JavaScript',           level: 'Advanced',  dots: 4 },
  { name: 'React',                level: 'Advanced',  dots: 4 },
  { name: 'Responsive Design',    level: 'Expert',    dots: 5 },
  { name: 'Git & Version Control',level: 'Proficient',dots: 3 },
];
